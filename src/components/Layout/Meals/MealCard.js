...
const MealCard = (props) => {
  ...
  return (
    <Card className="w-full max-w-[26rem] max-h-[500px] shadow-lg ">
      <CardHeader floated={false} color="blue-gray">
        <img src={props.imgSrc} alt="ui/ux review check" />
      ...
      <CardBody className="flex flex-col gap-3">
        <div className="mb-3 flex items-center justify-between">
          <Typography variant="h5" className="font-medium text-deep-orange-300">
            {props.title}
          </Typography>
          <Typography
            color="blue-gray"
        ...
        <MealItemForm id={props.id} onAddToCart={handleOnAddToCart} />
      </CardBody>
    </Card>
  );
};
